...
// in ditonton/test/presentation/bloc/tv_watchlist_bloc_test.dart.
...
import 'package:ditonton/domain/usecases/save_watchlist_tv.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveWatchlistTv extends _i1.Mock implements _i7.SaveWatchlistTv {
  MockSaveWatchlistTv() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i2.TvRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          ...
          as _i2.TvRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, String>> execute(_i8.TvDetail? tv) =>
